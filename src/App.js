    ...
    <Navbar bg="dark" variant="dark" expand="lg" className="border-bottom border-body justify-content-center">
      <Container>
        <Navbar.Brand as={Link} to="/">
          <img src="/public/SpellBooks.png" className="logo" alt="Logo" />
        </Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
        
            <Nav.Link as={Link} to="http://localhost:3003">Explore</Nav.Link>
            <Nav.Link as={Link} to="/">Borrow</Nav.Link>
  ...
  return (
    ...
    <div className="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
      <div className="col-lg-7 p-3 p-lg-5 pt-lg-3">
        ...
        Are you curious and want to read something? Well you're at the right place!
        </h1>
    ...
    <div className="container">
      <div className="row no-gutters">
        <div
          ...
          style={{
            backgroundImage:
              "url(images/hand-drawn-flat-design-stack-books-illustration_23-2149341898.jpg.avif)",
            height: 500
          }}
        ></div>
